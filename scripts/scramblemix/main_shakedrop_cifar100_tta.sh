...
python main.py --model_name shakedrop \
               --dataset cifar100 \
               --save_directory_name shakedrop_cifar100_"$num_of_TTA"_"$js_diverfence"_"$tta" \
               --milestones '150,225' \
               --weight_decay 5e-4 \
               --momentum 0.9 \
               --e 1 \
               ...
               --training_model_name random_pe_shakedrop_cifar100_"$num_of_TTA"_"$js_diverfence"_"$tta".t7 \
               > main_shakedrop_cifar100_"$num_of_TTA"_"$js_diverfence"_"$tta".txt 
